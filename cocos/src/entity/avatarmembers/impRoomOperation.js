...
var impRoomOperation = impGameRules.extend({
    ...
    notifyChangeController : function(controllerIdx){
        ...
        // this.curGameRoom.deskPokerList[this.curGameRoom.controllerIdx] = [];
        // if (h1global.curUIMgr && h1global.curUIMgr.gameRoomUIIsShow && h1global.curUIMgr.gameRoomUIIsShow()) {
        //     h1global.curUIMgr.roomLayoutMgr.notifyObserver(const_val.GAME_ROOM_UI_NAME, "update_player_discard_tiles",this.server2CurSitNum(controllerIdx), []);
        // }
