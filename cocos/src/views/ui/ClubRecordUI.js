...
var ClubRecordUI = UIBase.extend({
    ...
    initUI:function () {
        ...
        h1global.entityManager.player().clubOperation(const_val.CLUB_OP_GET_RECORDS, self.club.club_id);
    },
    ...
    group_record:function (record_list) {
        ...
        for(let i=0; i<record_list.length; i++){
            ...
            for(let j=0; j<player_info_list.length; j++){
                if(h1global.entityManager.player().userId === player_info_list[j]["userId"]){
