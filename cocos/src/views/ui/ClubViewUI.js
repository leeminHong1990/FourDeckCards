   ...
   ctor:function(){
    ...
    initUI:function () {
       var self = this;
        ...
        ui_panel.runAction(cc.MoveTo.create(0.15, cc.p(ui_panel.getContentSize().width, 0)));
        ...
        var club_entity_list = h1global.entityManager.player().club_entity_list;
        var club_base_list = [];
        for(var i=0; i<club_entity_list.length; i++){
            club_base_list.push(club_entity_list[i].club_base_info);
        }
        ...
        function update_item_func(itemPanel, itemData, index) {
            ...
            function item_panel_event(sender, eventType) {
                if(eventType === ccui.Widget.TOUCH_ENDED){
                    ...
                    h1global.entityManager.player().getClubDetailInfo(itemData["club_id"]);
                    self.close();
    ...
    close:function () {
        ...
        ui_panel.runAction(cc.Sequence.create(
            cc.MoveTo.create(0.15, cc.p(-ui_panel.getContentSize().width, 0)),
