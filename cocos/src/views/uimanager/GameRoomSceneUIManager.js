var GameRoomSceneUIManager = UIManagerBase.extend({
    onCreate: function () {
        ...
        var initUIClassNameList = ["GameRoom2DUI", "GameRoom3DUI", "GameRoomPrepareUI", "GameRoomInfoUI", "AudioRecordUI", "SettlementUI", "ResultUI", "HelpUI", "ConfigUI", "GamePlayerInfoUI", "CommunicateUI", "ShareUI", "ApplyCloseUI", "GPSUI"];
