...
# 支付模式
NORMAL_PAY_MODE = 0 # 正常房间, 房主支付
AA_PAY_MODE = 1		# 开房, AA支付(legacy代码, 应该不会用到了)
...
OP_WIN_THREE = 102		#三家
OP_WIN_LAST = 103		#末家
OP_WIN_LIST = [OP_WIN_ONE, OP_WIN_TWO, OP_WIN_THREE, OP_WIN_LAST]
...
# 玩家要不起操作的默认延时下发时间（单位：秒）
DELAY_OP_PASS = 1

VALID_TILES = (HEI, HONG, MEI, FANG, JOKER)